...
from renda.selectors import (get_aggregations_rendas, get_annotations_rendas,
                             get_rendas_by_user)
...
class VisaoGeralView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        # * Annotations
        ann_rendas = get_annotations_rendas(rendas_do_mes)
        ann_invest = get_annotations_investimentos(investimentos_do_mes)
        ...
        ctx = {
            ...
            'sem_lancamento': sem_lancamento,
            'annotations_rendas': ann_rendas,
            'annotations_invest': ann_invest,
...
class VisaoGeralProxMesView(LoginRequiredMixin, View):
    login_url = "home:login"
    ...
    def get(self, request):
        ...
        return render(
            request,
            'dashboard/pages/visao_geral_prox_mes.html',
            ctx
        )
